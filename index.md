...
- Advanced Linear Mixed Models (frequentist stream): [Detailed syllabus](https://github.com/vasishth/SMLP2017/blob/master/AdvancedLMM/Adv_LMM_Lectures_Overview.pdf), data and code to come soon. **Please download the syllabus to have access to the links in the syllabus**.
